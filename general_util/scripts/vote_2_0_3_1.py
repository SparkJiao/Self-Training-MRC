...
# model2_dir = 'experiments/coqa-tri-training/v2.0/coqa-neg-tri-1/'
# output_file = model2_dir + 'v2.0-0-3-vote.pkl'
...
# model2_dir = 'experiments/coqa-tri-training/v2.0/coqa-re1-tri-1/'
# old_file = 'experiments/coqa-tri-training/v2.0/coqa-neg-tri-1/v2.0-0-3-vote.pkl'
# Labeled 13472 data in total
...
model2_dir = 'experiments/coqa-tri-training/v2.0/coqa-re2-tri-1/'
old_file = 'experiments/coqa-tri-training/v2.0/coqa-re1-tri-1/v2.0-0-3-vote.pkl'
# Labeled 16586 data in total
output_file = model2_dir + 'v2.0-0-3-vote.pkl'
