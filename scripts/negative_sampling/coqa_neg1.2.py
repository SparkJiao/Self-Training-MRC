...
sample_ratio = 0
read_seed = 42
task_name = 'coqa-sen-test-{}-{}-{}'.format(do_negative_sampling, read_extra_self, sample_ratio)


output_dir = f"experiments/negative_sample/coqa-coqa-1.2/"
...
cmd = f"python transfer_main.py --bert_model bert-base-uncased --vocab_file {bert_base_vocab} --model_file {bert_base_model} " \
    ...
    f"--sample_ratio {sample_ratio} --negative_lambda 0.0 --read_seed 42 "
