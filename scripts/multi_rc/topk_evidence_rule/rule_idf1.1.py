...
gen_cmd = f'python scripts/gen_evidence_by_rule.py --task_name MultiRC --input_file {train_file} --top_k {3000} ' \
          f'--num_evidences {3} --output_file {root_dir}sentence_id_rule1.1-3000-3.json'
run_cmd(gen_cmd)

output_dir = f'{root_dir}v1.1/'
rule_sentence_id_file = f'{root_dir}sentence_id_rule1.1-3000-3.json'
