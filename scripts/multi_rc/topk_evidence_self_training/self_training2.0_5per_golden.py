...
sentence_id_file = '/home/jiaofangkai/CoQA-Challenge/BERT_RC/multi_rc_golden_sentence_id_file_5per.json'
num_evidence = 3

root_dir = f'experiments/multi-rc/topk-evidence/self-training/v2.0_acc_top{k}_5per_golden'
