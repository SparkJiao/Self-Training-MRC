...
evidence_lambda = 0.8
weight_threshold = [0.5, 0.6, 0.7, 0.8, 0.8]
label_threshold = [0.5, 0.6, 0.7, 0.8, 0.8]
recurrent_times = 5
...
for i in range(0, recurrent_times):
    ...
    output_dir = f"experiments/marco-cb-dp0.7-stage/v1.2/recurrent{i}/"
    ...
    cmd = f"python main.py \
            ...
            --do_label \
            --weight_threshold {weight_threshold[i]} \
            --only_correct \
            --label_threshold {label_threshold[i]}  "
