...
task_name = 'marco-cb-stage-dp0.7'
bert_name = 'hie'
...
# evidence_lambda = [0.7, 0.5, 0.4, 0.3, 0.2]
evidence_lambda = [0.9, 1.0, 0.1]

sentence_id_file = 'experiments/marco-cb-dp0.7-stage/v1.7/recurrent0/sentence_id_file.json'

for i in range(0, recurrent_times):
    logger.info(f'Running at the {i}th times...')

    output_dir = f"experiments/marco-cb-dp0.7-stage/v2.{i + 5}/recurrent1/"
    ...
    cmd = f"python main.py \
            ...
            --predict_file ../../ms-marco/dp0.7/dev-yesno-cb-dp70.json \
            ...
            --evidence_lambda {evidence_lambda[i]} \
            --do_label \
