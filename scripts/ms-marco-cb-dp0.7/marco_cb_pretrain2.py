...
# bert_name = 'mlp'
#
# output_dir = f"experiments/marco-cb-dp0.7-mlp-pretrained/v1.0/"
#
...
output_dir = f"experiments/marco-cb-dp0.7-hie-pretrained/v2.0/"
...
output_dir = f"experiments/marco-cb-dp0.7-hie-super-pretrained/v2.0/"
