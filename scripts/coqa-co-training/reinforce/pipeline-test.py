...
output_dir = 'experiments/coqa/reinforce/pipeline-test/gumbel-pre-train'
...
output_dir = 'experiments/coqa/reinforce/pipeline-test/reinforce-tune'
...
cmd = f"python main_0.6.2.py --bert_model bert-base-uncased --vocab_file {bert_base_vocab} --model_file {bert_base_model} " \
    ...
    f"--pretrain experiments/coqa/reinforce/pipeline-test/gumbel-pre-train/pytorch_model.bin "
