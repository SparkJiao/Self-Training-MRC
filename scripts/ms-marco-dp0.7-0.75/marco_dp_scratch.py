...
output_dir = f"experiments/marco-dp0.7-0.75-mlp/v1.0/"
...
output_dir = f"experiments/marco-dp0.7-0.75-hie/v1.0/"
...
output_dir = f"experiments/marco-dp0.7-0.75-hie-pretrain/v1.0/"
...
cmd = f"python main.py \
            ...
            --predict_file {dev_file} \
            --max_seq_length 400 --max_query_length 50 \
            --do_train --do_predict --train_batch_size  7 --predict_batch_size 7 --max_answer_length 15 \
...
output_dir = f"experiments/marco-dp0.7-0.75-hie-super-pretrain/v1.0/"
