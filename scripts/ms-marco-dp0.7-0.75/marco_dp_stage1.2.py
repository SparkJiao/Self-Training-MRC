...
evidence_lambda = [0.6, 0.4]
num_train_epochs = [4, 3]
learning_rate = [5e-5, 3e-5]

sentence_id_file = f"experiments/marco-dp0.7-0.75-stage/v1.1/recurrent0/sentence_id_file.json"

for i in range(0, recurrent_times):
    logger.info(f'Running at the {i}th times...')

    output_dir = f"experiments/marco-dp0.7-0.75-stage/v1.{2 + i}/recurrent1/"
