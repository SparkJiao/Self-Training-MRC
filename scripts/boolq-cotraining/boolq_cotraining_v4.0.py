...
for i in range(recurrent_times):
    for view_id in range(view_num):
        ...
        output_dir = f"experiments/boolq-cotraining/v4.0/recurrent{i}_view{view_id}/"
        ...
        if i == 0:
            ...
            if i > 1:
                origin_sentence_id_file = f"experiments/boolq-cotraining/v4.0/recurrent{i-1}_view{1-view_id}/sentence_id_file.json"
                merge_cmd = f"python merge.py \
                                --predict1 experiments/boolq-cotraining/v4.0/recurrent0_view{view_id}/sentence_id_file_recurrent{i-1}.json.merge \
                                --predict2 {origin_sentence_id_file} \
                                --output_dir experiments/boolq-cotraining/v4.0/recurrent0_view{view_id}/sentence_id_file_recurrent{i}.json.merge"
                os.system(merge_cmd)

            sentence_id_file = f"experiments/boolq-cotraining/v4.0/recurrent0_view{view_id}/sentence_id_file_recurrent{i}.json.merge"
