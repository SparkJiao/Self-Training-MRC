...
for i in range(0, recurrent_times):
    ...
    output_dir = f"experiments/marco-stage/v1.0/recurrent{i}/"
    ...
    cmd = f"python main.py \
            ...
            --train_file ../../ms-marco/train-yesno-throw-yes-uni.json \
            --predict_file ../../ms-marco/dev-yesno-throw-yes-uni.json \
