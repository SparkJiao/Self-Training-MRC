...
root_dir = f'experiments/race/topk-evidence/combine/co-training/v2.0_acc_top{50000}'
...
sentence_id_files = [
    f'{root_dir}/recurrent8_view0-recurrent7_view1-False-inter-merge-180704-94143-274847.json',
    f'{root_dir}/recurrent8_view0-recurrent7_view1-True-inter-merge-180704-94143-180704.json'
]
