...
output_dir = f'experiments/race/high/gumbel-pre-train/v1.0_seed{args.seed}'
...
cmd = f'python main_multi_choice_top_k_evidence.py --bert_model bert-base-uncased ' \
      ...
      f'--pretrain experiments/race/high/gumbel-pre-train/v1.0_seed{args.seed}/pytorch_model.bin '
