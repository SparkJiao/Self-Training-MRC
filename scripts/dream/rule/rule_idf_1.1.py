...
gen_cmd = f'python scripts/gen_evidence_by_rule.py --task_name RACE --input_file {train_file} --top_k {10000} ' \
    f'--num_evidences {4} --output_file {root_dir}/sentence_id_rule1.1-10000-4.json'
# run_cmd(gen_cmd)

output_dir = f'{root_dir}/idf_v1.1'
rule_sentence_id_file = f'{root_dir}/sentence_id_rule1.1-10000-4.json'
