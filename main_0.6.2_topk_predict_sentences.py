    ...
    if args.do_label and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        for batch in tqdm(test_dataloader, desc="Testing"):
            ...
            with torch.no_grad():
                ...
                batch_sentence_sim = output_dict['sentence_sim']
            ...
            for i, example_index in enumerate(example_indices):
                ...
                sentence_logits = batch_sentence_sim[i].detach().cpu().tolist()
        ...
        _, metric, _ = data_reader.write_sentence_predictions(test_examples, test_features, all_results,
