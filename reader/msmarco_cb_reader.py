...
from data.data_instance import SQuADFullExample, SQuADFullInputFeatures, RawResultChoice, WeightResultChoice, ModelState
...
class MSMARCOYesNoCBReader(object):
    def __init__(self):
        super(MSMARCOYesNoCBReader, self).__init__()
