...
from data.data_instance import RawResultChoice, WeightResultChoice, ModelState
...
This script uses pytorch-transformers, which is named as pytorch-pretrained-bert before. The former is the version 1.0 of the latter.
